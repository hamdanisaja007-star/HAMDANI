...
<head>
    ...
    <style>
        ...
        /* --- TAMPILAN DASHBOARD --- */
        #dashboard-layer { display: none; padding: 20px; background-image: linear-gradient(rgba(0, 240, 255, 0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 240, 255, 0.05) 1px, transparent 1px); background-size: 30px 30px; }
        ...
        .btn-cyber { 
            ...
            color: white; font-weight: bold; cursor: pointer; text-align: left; text-decoration: none; font-size: 12px; box-sizing: border-box;
        }
        .btn-cyber:hover { background: var(--cyan); color: black; box-shadow: 0 0 20px var(--cyan); }
        
        .visual-box { width: 100%; height: 150px; margin-bottom: 15px; border: 1px solid #222; overflow: hidden; background: #000; }
    </style>
</head>
<body>
    ...
    <div id="login-layer">
        <div class="login-box">
            <h2>SIKEPAL ACCESS</h2>
            <input type="password" id="key" placeholder="ENTER ACCESS KEY">
            <button class="btn-auth" onclick="unlock()">INITIALIZE</button>
        </div>
    </div>
    ...
    <div id="dashboard-layer">
        ...
        <div class="ticker-wrap">
            <div class="ticker">SIKEPAL SYSTEM READY... CONNECTING TO NEWSIGA... MONITORING ACTIVE... CIKEMBAR STATION ONLINE... UPDATING DATA...</div>
        </div>
        ...
        <div class="main-grid">
            <div class="panel">
                ...
                <button class="btn-cyber">👥 KELOMPOK PIK-R</button>
            </div>
            ...
            <div class="panel">
                ...
                <div style="margin-top: 15px; border: 1px dashed var(--green); padding: 10px; font-size: 10px;">
                   <span style="color: var(--green);">[ LOGISTIC CENTER ]</span><br>
                   Kertas HVS A4 - Promo Aktif!<br>
                   <button class="btn-cyber" style="border-color: var(--green); margin-top: 5px; height: 30px; font-size: 9px;">🛒 CEK SHOPEE</button>
                </div>
            </div>
            ...
            <div class="panel">
                ...
                <a href="https://simsdm.bkkbn.go.id" target="_blank" class="btn-cyber">🔗 SIMSDM_BKKBN</a>
        ...
        <div style="text-align: center; margin-top: 40px; color: #555; font-size: 11px;">
            DEDE BIMZ & RAHMAN &copy; 2026 | <button onclick="location.reload()" style="background:none; border:none; color:red; cursor:pointer;">[ EXIT SYSTEM ]</button>
        </div>
    </div>
