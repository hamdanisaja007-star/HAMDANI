...
# KODE HTML UTUH TANPA TERPOTONG
HTML_FULL = """
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        ...
        .visual-box img, .visual-box video { width: 100%; height: 100%; object-fit: cover; opacity: 0.9; }
        ...
        .btn-cyber { display: block; width: 100%; padding: 12px; margin-bottom: 8px; background: rgba(0, 240, 255, 0.05); border: 1px solid var(--cyan); color: white; font-weight: bold; cursor: pointer; text-align: left; transition: 0.3s; font-size: 12px; box-sizing: border-box; }
        ...
        .lock-box { width: 350px; padding: 30px; border: 2px solid var(--cyan); background: #05050a; text-align: center; }
        .lock-input { width: 100%; padding: 10px; margin: 15px 0; background: #111; border: 1px solid var(--cyan); color: var(--cyan); text-align: center; font-size: 18px; outline: none; box-sizing: border-box; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="ticker-wrap"><div class="ticker" id="running-text">INITIALIZING... STANDBY FOR SYSTEM BROADCAST...</div></div>

    <div class="main-grid">
        <div class="panel">
            <div class="panel-title">📂 MODULE ENTRI SIGA</div>
            <div class="visual-box">
                <img id="img-1" src="https://raw.githubusercontent.com/hamdanisaja007-star/HAMDANI/main/static/banner1.jpg">
                <div class="ads-label" id="txt-1">SIKEPAL ADS 1</div>
            </div>
            <div id="siga-locked"><button class="btn-cyber" onclick="showLock('FOLDER SIGA', 'folder_siga')">🔓 OPEN SIGA MODULES</button></div>
            <div id="siga-unlocked" style="display: none;">
                ...
                <button class="btn-cyber" onclick="lockSiga()">🔒 CLOSE FOLDER</button>
            </div>
        </div>
        ...
        <div class="panel">
            ...
            <div class="visual-box" style="border-color: var(--pink); height: 160px;">
                ...
                <div class="ads-label" style="color: var(--pink);">EXCLUSIVE VIDEO MONITOR</div>
            </div>
            <div class="affiliate-mini">
                <button class="btn-cyber" style="border-color:var(--green); font-size:10px;" onclick="window.open('https://shope.ee/link_hvs_bapak')">🛒 KERTAS HVS A4 - RP 45.000</button>
            </div>
            <button class="btn-cyber btn-pink" style="margin-top:10px;" onclick="window.open('https://youtube.com/@bimz82official50')">▶ BIMZ82 OFFICIAL</button>
        </div>

        <div class="panel">
            <div class="panel-title">🌐 EXTERNAL HUB</div>
            <div class="visual-box">
                <img id="img-3" src="https://raw.githubusercontent.com/hamdanisaja007-star/HAMDANI/main/static/banner2.jpg">
                <div class="ads-label" id="txt-3">PARTNER HUB</div>
            </div>
    ...
    <div class="lock-overlay" id="lock-screen">
        <div class="lock-box">
            <div style="color: var(--cyan); font-weight: bold; margin-bottom: 10px;">🔐 ACCESS KEY REQUIRED</div>
            <input type="password" id="access-key" class="lock-input" placeholder="BIMZ2026">
    ...
    <script>
        ...
        function exe(name, url) { window.open(url, '_blank'); }
    </script>
</body>
</html>
"""
